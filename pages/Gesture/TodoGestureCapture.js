...
export default function TodoGestureCapture() {
    ...
    const todoCaptureOk = () => {
        axios.get("http://automirror00001.duckdns.org:8080/api/gesture?message=todo-capture-ok")
                      .then((response) => {
    ...
    const todoCaptureNo = () => {
        axios.get("http://automirror00001.duckdns.org:8080/api/gesture?message=todo-capture-no")
                      .then((response) => {
                        console.log(response.status);
                        if (response.status === 200) {
